!function(t) {
    ...
    , function(t, n, r) {
        var e = r(3)
            ...
            , a = "prototype"
            , s = function(t, n, r) {
            var f, l, h, v, p = t & s.F, d = t & s.G, g = t & s.S, y = t & s.P, m = t & s.B, x = d ? e : g ? e[n] || (e[n] = {}) : (e[n] || {})[a], b = d ? i : i[n] || (i[n] = {}), w = b[a] || (b[a] = {});
            d && (r = n);
            for (f in r)
                l = !p && x && void 0 !== x[f],
                    h = (l ? x : r)[f],
    ...
    , function(t, n, r) {
        ...
        if (r(7)) {
            var e = r(34)
                ...
                , Nt = function(t, n) {
                for (var r = 0, e = n.length, i = At(t, e); e > r; )
                    i[r] = n[r++];
                return i
            }
                , Rt = function(t, n, r) {
                ...
                , Tt = function(t) {
                var n, r, e, i, o, u, c = _(t), a = arguments.length, f = a > 1 ? arguments[1] : void 0, l = void 0 !== f, h = M(c);
                if (void 0 != h && !S(h)) {
                    for (u = h.call(c),
                             e = [],
                             n = 0; !(o = u.next()).done; n++)
                ...
                , Bt = function(t, n, r) {
                return !(Vt(t, n = y(n, !0)) && w(r) && m(r, "value")) || m(r, "get") || m(r, "set") || r.configurable || m(r, "writable") && !r.writable || m(r, "enumerable") && !r.enumerable ? W(t, n, r) : (t[n] = r.value,
                    t)
            };
            _t || (U.f = qt,
                D.f = Bt),
            ...
            v(Jt, Gt),
                ...
                t.exports = function(t, n, r, a) {
                    ...
                    x ? (g = r(function(t, r, e, i) {
                        ...
                        var o, u, c, a, l = 0, v = 0;
                        if (w(r)) {
                            if (!(r instanceof Z || (a = b(r)) == B || a == J))
                                return St in r ? Nt(g, r) : Tt.call(g, r);
                            o = r,
                                v = Pt(e, n);
                            var p = r.byteLength;
                            if (void 0 === i) {
                        ...
                        S = g[K] = E(Jt),
                        h(S, "constructor", g)) : R(function(t) {
                        new g(null),
                            new g(t)
            ...
            , n = t.exports = function(t, n, r, l, h) {
                ...
                if (o(y)) {
                    for (v = c(t.length); v > x; x++)
                        if (g = n ? m(u(p = t[x])[0], p[1]) : m(t[x]),
                            g === s || g === f)
                            return g
                } else
                    for (d = y.call(t); !(p = d.next()).done; )
                        if (g = i(d, m, p.value, n),
                            g === s || g === f)
                            return g
            }
        ;
    ...
    , function(t, n, r) {
        ...
        function e(t, n, r, e) {
            var i;
            "function" != typeof r || e ? "function" == typeof e && (i = e) : (i = r,
                r = null);
            var o = $("#flash-message")
                , r = parseInt(r) || 3e3
                , t = "error" == t ? "danger" : t
            ...
            $.get(t).done(function(t) {
                if ("success" == t.status) {
                    ...
                    for (var o = 0, u = e.length; o < u; o++)
                        i += '<div class="clearfix sidebox-body users-top-body"><div class="pull-left users-top-left">' + a.userAvatar(e[o], "pull-left") + '<div class="users-top-info pull-left">' + a.userName(e[o]) + '<br><span class="users-top-study-time">' + e[o].study_time + ' 分钟</span></div></div><div class="pull-right users-top-right"><img src="' + e[o].image + '"></div></div>';
                    i += "</div>",
    ...
    , function(t, n, r) {
        for (var e, i = r(3), o = r(13), u = r(41), c = u("typed_array"), a = u("view"), s = !(!i.ArrayBuffer || !i.DataView), f = s, l = 0, h = 9, v = "Int8Array,Uint8Array,Uint8ClampedArray,Int16Array,Uint16Array,Int32Array,Uint32Array,Float32Array,Float64Array".split(","); l < h; )
            (e = i[v[l++]]) ? (o(e.prototype, c, !0),
    ...
    , function(t, n, r) {
        ...
        t.exports = function(t, n, r, m, x, b, w) {
            ...
            }, F = n + " Iterator", M = x == g, k = !1, $ = t.prototype, P = $[h] || $[p] || x && $[x], j = P || O(x), A = x ? M ? O("entries") : j : void 0, I = "Array" == n ? $.entries || P : P;
            if (I && (E = l(I.call(new t)),
                E !== Object.prototype && (f(E, F, !0),
                e || c(E, h) || u(E, h, y))),
                M && P && P.name !== g && (k = !0,
                        j = function() {
                            return P.call(this)
    ...
    , function(t, n, r) {
        var e, i, o, u = r(26), c = r(55), a = r(68), s = r(65), f = r(3), l = f.process, h = f.setImmediate, v = f.clearImmediate, p = f.MessageChannel, d = 0, g = {}, y = "onreadystatechange", m = function() {
            var t = +this;
    ...
    , function(t, n, r) {
        ...
        var e = r(3)
            ...
            , C = i ? "_o" : R
            , D = function(t, n, r) {
            var e, i, o, u = Array(r), c = 8 * r - n - 1, a = (1 << c) - 1, s = a >> 1, f = 23 === n ? $(2, -24) - $(2, -77) : 0, l = 0, h = t < 0 || 0 === t && 1 / t < 0 ? 1 : 0;
            for (t = k(t),
                     t != t || t === F ? (i = t != t ? 1 : 0,
                         e = a) : (e = P(j(t) / A),
                     t * (o = $(2, -e)) < 1 && (e--,
            ...
            if (u != c || c < 0 || c + n > t[L])
                throw O(w);
            for (var a = t[T]._b, s = c + t[C], f = e(+i), h = 0; h < n; h++)
                a[s + h] = f[o ? h : n - h - 1]
        }
            , X = function(t, n) {
            f(t, _, y);
        ...
        if (u.ABV) {
            if (!s(function() {
                ...
                ;
                for (var Z, H = _[x] = M[x], Q = v(M), tt = 0; Q.length > tt; )
                    (Z = Q[tt++])in _ || c(_, Z, M[Z]);
                o || (H.constructor = _)
            }
        ...
        t.exports = !a || r(4)(function() {
            ...
            7 != a({}, t)[r] || Object.keys(a({}, n)).join("") != e
                ...
                for (var r = u(t), a = arguments.length, s = 1, f = i.f, l = o.f; a > s; )
                    for (var h, v = c(arguments[s++]), p = f ? e(v).concat(f(v)) : e(v), d = p.length, g = 0; d > g; )
    ...
    , function(t, n, r) {
        "use strict";
        var e, i = r(22)(0), o = r(14), u = r(29), c = r(104), a = r(98), s = r(5), f = u.getWeak, l = Object.isExtensible, h = a.ufstore, v = {}, p = function(t) {
            return function() {
                return t(this, arguments.length > 0 ? arguments[0] : void 0)
            }
        }, d = {
        ...
        7 != (new g).set((Object.freeze || Object)(v), 7).get(v) && (e = a.getConstructor(p),
            c(e.prototype, d),
            u.NEED = !0,
                                ...
                                case 2:
                                    r = t.sent,
                                        "success" == r.status ? setTimeout(function() {
                                            ...
                                            o.flashMessage(r.status, r.message));
                                case 4:
                                case "end":
                                    return t.stop()
                            }
            ...
            //     }, 3e3)),
                ...
                $(".words-ctrl form input, .words-ctrl form textarea").on("keyup keypress", function() {
                    var t = $(this).attr("min")
                        ...
                        , r = $(this).val().length
                        , e = "";
                    void 0 !== t && void 0 !== n && (e = r < t ? '<span class="text-danger">字数太少，至少需要' + t + "字</span>" : r > n ? '<span class="text-danger">字数太多，不能超过' + n + "字</span>" : '<span class="text-success">还能输入' + (n - r) + "字</span>",
                        $(this).parent().find(".help-block").html(e).show())
                })
        }),
            $(function() {
                $("input[name=school]").on("keypress keyup", function() {
                    ...
                    $.get("/search/college", {
                        ...
                        if (n.data.length) {
                            for (var r = n.data, e = '<div class="college-suggestion">', i = 0; i < r.length; i++)
                                e += "<a>" + r[i] + "</a>";
                            e += "</div>",
                                $(t).parent().append(e),
            ...
            $(function() {
                $(".navbar-form input[name=search]").on("keypress keyup", function() {
                    ...
                    $.get("/search/json", {
                        ...
                        if (n.data.length) {
                            for (var r = n.data, e = '<div class="search-autocomplete">', i = 0; i < r.length; i++)
                                e += '<a href="/search?search=' + encodeURIComponent(r[i]) + '">' + r[i] + "</a>";
                            e += "</div>",
                                        ...
                                        case 2:
                                            e = t.sent,
                                                ...
                                                "success" == e.status ? (this.$signModal.modal("hide"),
                                                    this.next.updated ? window.location.href = this.next.url : window.location.reload()) : "error" == e.status && (this.updateVerifyCode(this.$verifyCode),
                                                this.needLoginCode && this.showLoginCode(),
    ...
    , function(t, n, r) {
        ...
        e && (e.on("event:user:logout", function() {
            return !localStorage.isClient && (e.emit("disconnection", ""),
                void e.disconnect())
        }),
    ...
    , function(t, n, r) {
        ...
        i(i.S + i.F * !r(57)(function(t) {
            ...
            from: function(t) {
                var n, r, i, l, h = o(t), v = "function" == typeof this ? this : Array, p = arguments.length, d = p > 1 ? arguments[1] : void 0, g = void 0 !== d, y = 0, m = f(h);
    ...
    , function(t, n, r) {
        ...
        if (!p(" 0o1") || !p("0b1") || p("+0x1")) {
            ...
            ;
            for (var b, w = r(7) ? s(d) : "MAX_VALUE,MIN_VALUE,NaN,NEGATIVE_INFINITY,POSITIVE_INFINITY,EPSILON,isFinite,isInteger,isNaN,isSafeInteger,MAX_SAFE_INTEGER,MIN_SAFE_INTEGER,parseFloat,parseInt,isInteger".split(","), _ = 0; w.length > _; _++)
    ...
    , function(t, n, r) {
        ...
        var e = r(47)
            , i = {};
        i[r(6)("toStringTag")] = "z",
        i + "" != "[object z]" && r(14)(Object.prototype, "toString", function() {
    ...
    , function(t, n, r) {
        "use strict";
        var e, i, o, u = r(34), c = r(3), a = r(26), s = r(47), f = r(1), l = r(5), h = r(12), v = r(33), p = r(43), d = r(79), g = r(84).set, y = r(76)(), m = "Promise", x = c.TypeError, b = c.process, w = c[m], b = c.process, _ = "process" == s(b), S = function() {}, E = !!function() {
            try {
                var t = w.resolve(1)
                        ...
                        try {
                            u ? (i || (2 == t._h && I(t),
                                ...
                                u === !0 ? r = e : (s && s.enter(),
                                    r = u(e),
                                s && s.exit()),
                                r === n.promise ? a(x("Promise-chain cycle")) : (o = F(r)) ? o.call(r, c, a) : c(r)) : a(e)
                        } catch (t) {
                            a(t)
                        }
                    }; r.length > o; )
    ...
    , function(t, n, r) {
        function e(t, n, r) {
            ...
            return c(p, "value") ? !(p.writable === !1 || !l(v)) && (a = o.f(v, n) || s(0),
                a.value = r,
                i.f(v, n, a),
    ...
    , function(t, n, r) {
        ...
        var e = r(3)
            ...
            return t === W && Y(U, n, r),
                ...
                n = w(n, !0),
                x(r),
                i(D, n) ? (r.enumerable ? (i(t, R) && t[R][n] && (t[R][n] = !1),
                    r = S(r, {
                        enumerable: _(0, !1)
                    })) : (i(t, R) || $(t, R, _(1, {})),
                    t[R][n] = !0),
            ...
            , Q = function(t) {
            for (var n, r = P(b(t)), e = [], o = 0; r.length > o; )
                i(D, n = r[o++]) || n == R || n == a || e.push(n);
            return e
        }
            , tt = function(t) {
            for (var n, r = t === W, e = P(r ? U : b(t)), o = [], u = 0; e.length > u; )
        ...
        z || (j = function() {
                ...
                r(49).f = Z,
                r(59).f = tt,
            o && !r(34) && c(W, "propertyIsEnumerable", Z, !0),
                p.f = function(t) {
                    return B(v(t))
                }
        ),
    ...
    , function(t, n, r) {
        (function(n, r) {
                !function(n) {
                            ...
                            for (; ; ) {
                                ...
                                if ("next" === o)
                                    ...
                                    if (e === E)
                                        throw e = M,
                                            u;
                                    r.dispatchException(u) && (o = "next",
                                        u = g)
                                } else
                                    "return" === o && r.abrupt("return", u);
                                e = F;
                                var s = i(t, n, r);
                                if ("normal" === s.type) {
                                    e = r.done ? M : O;
                    ...
                    var g, y = Object.prototype, m = y.hasOwnProperty, x = "function" == typeof Symbol ? Symbol : {}, b = x.iterator || "@@iterator", w = x.toStringTag || "@@toStringTag", _ = "object" == typeof t, S = n.regeneratorRuntime;
                    if (S)
                        return void (_ && (t.exports = S));
    ...
    , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , function(t, n, r) {
        ...
        e = [r(120)],
            i = function(t) {
                ...
                n || (t.flashMessage("error", "检测到您的浏览器不支持Canvas或是IE9版本以下的浏览器，请使用Chrome、Firefox或IE 9以上版本的浏览器登录实验楼。", 1e4),
                    console.log("检测到您的浏览器不支持Canvas或是IE9版本以下的浏览器，请使用Chrome、Firefox或IE 9以上版本的浏览器登录实验楼。"));
                ...
                e.blur(function() {
                    var t = /^[\u4e00-\u9fa5\w\_]+$/g
                        , n = $(this).val().trim();
                    return !t.test(n) || n.length < 2 ? (t.lastIndex = 0,
                        e.next().html("用户名长度必须大于2并且只能包括中文、字母、数字及下划线!"),
                        !1) : void $.post(r.postUrl, {
                        "check-type": "name",
                        value: n
                    }).done(function(t) {
                        return t.exists ? (e.next().html("此用户名已经被注册了!"),
                            !1) : void e.next().html("")
                    })
                }),
                    i.blur(function() {
                    ...
                    $("button.register").click(function(t) {
                        var n = e.val().trim().length
                            , r = i.val().trim().length
                            , u = o.val().length;
                        n < 2 ? (e.next().html("用户名长度必须大于2并且只能包括中文、字母、数字及下划线!"),
                            t.preventDefault()) : r ? (u < 6 || u > 16) && (o.next().html("密码长度必须为6-16位!"),
                            t.preventDefault()) : (i.next().html("请填写正确格式的邮箱!"),
                            t.preventDefault())
                    }),
                    $(".activity-container .container").height($(".activity-container .container img").height()),
                    $("#capImg").on("click", function() {
